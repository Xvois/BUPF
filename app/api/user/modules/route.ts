...
export async function GET() {
    ...
    // If the user is not enrolled in a course, return all modules (id === 0 is "Other" course)
    if (courses === null || courses?.id === 0 || entry === null) {
    ...
    if (courseModulesResponse.error) {
        return Response.json(courseModulesResponse);
    }
