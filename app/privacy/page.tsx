	...
	return (
		<div>
			<div className={"relative flex flex-col h-96 items-center align-middle justify-center space-y-8"}>
				<h1 className={"font-black text-4xl sm:text-5xl md:text-6xl lg:text-7xl"}>Privacy Policy</h1>
				<p>Last updated: May 17, 2024</p>
			</div>
			<div className={"p-6 space-y-2 divide-y divide-solid w-fit mx-auto"}>
				<SectionWrapper>
				...
				<SectionWrapper>
					<h2 className={"font-black text-2xl sm:text-3xl md:text-4xl lg:text-5xl"}>Interpretation and
						Definitions</h2>
					<h3 className={"font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl"}>Interpretation</h3>
					<p>The words of which the initial letter is capitalized have meanings defined under the following
						conditions. The following definitions shall have the same meaning regardless of whether they
						appear
						in
						singular or in plural.</p>
					<h3 className={"font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl"}>Definitions</h3>
					...
					<ul className={"list-outside list-disc"}>
						...
						<li>
							<p><strong>Website</strong> refers to BUPF, accessible from <a href="https://www.bupf.co.uk"
																						   rel="external nofollow noopener"
																						   target="_blank">https://www.bupf.co.uk</a>
							</p>
						</li>
						<li>
				...
				<SectionWrapper>
					<h2 className={"font-black text-2xl sm:text-3xl md:text-4xl lg:text-5xl"}>Collecting and Using Your
						Personal Data</h2>
					<h3 className={"font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl"}>Types of Data
						Collected</h3>
					...
					<h3 className={"font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl"}>Use of Your Personal
						Data</h3>
					...
					<h3 className={"font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl"}>Retention of Your Personal
						Data</h3>
					...
					<h3 className={"font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl"}>Delete Your Personal
						Data</h3>
					...
					<p>You may update, amend, or delete Your information at any time by signing in to Your Account, if
						you
						have
						one, and visiting the account settings section that allows you to manage Your personal
						information.
						You
						may also contact Us to request access to, correct, or delete any personal information that You
						have
						provided to Us.</p>
					...
					<h3 className={"font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl"}>Disclosure of Your Personal
						Data</h3>
					...
					<h3 className={"font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl"}>Security of Your Personal
						Data</h3>
				...
				<SectionWrapper>
					<h2 className={"font-black text-2xl sm:text-3xl md:text-4xl lg:text-5xl"}>Links to Other
						Websites</h2>
				...
				<SectionWrapper>
					<h2 className={"font-black text-2xl sm:text-3xl md:text-4xl lg:text-5xl"}>Changes to this Privacy
						Policy</h2>
				...
				<SectionWrapper>
					<h2 className={"font-black text-2xl sm:text-3xl md:text-4xl lg:text-5xl"}>Contact Us</h2>
					<p>If you have any questions about this Privacy Policy, You can contact us:</p>
					<ul className={"list-outside list-disc"}>
						<li>By email: sonnymparker9@gmail.com</li>
					</ul>
				</SectionWrapper>
			</div>
		</div>
